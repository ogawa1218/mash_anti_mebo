...
<div class="copy">
  <span class="line1">忙しい人ほど</span>
  <span class="line2">種目を減らせ。</span>
  <span class="line3">迷ったらバーピー</span>
  <span class="sub">週3回・8分で見た目は変わる</span>
</div>
...
if __name__ == "__main__":
    print("第8回 サムネイル生成開始 (HTML/CSS + Playwright)...\n")
